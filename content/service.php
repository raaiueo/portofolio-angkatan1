...
if (isset($_GET['delete'])) {
  ...
  header("Locarion:?page=service&notif=success");
}
?>
              ...
              foreach ($queryService as $row) : ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="?page=service&delete=<?php echo $row['id'] ?>" onclick="return confirm('Gueeee apushhh nichhh ngabbbss')" class="btn btn-danger btn-sm">Deleted</a>
                  </td>
                </tr>
              <?php endforeach ?>
