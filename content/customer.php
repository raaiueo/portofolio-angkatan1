...
if (isset($_GET['delete'])) {
  ...
  header("Locarion:?page=customer&notif=success");
}
?>
              ...
              foreach ($queryCustomer as $row) : ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="?page=customer&delete=<?php echo $row['id'] ?>" onclick="return confirm('Gueeee apushhh nichhh ngabbbss')" class="btn btn-danger btn-sm">Deleted</a>
                  </td>
                </tr>
              <?php endforeach ?>
