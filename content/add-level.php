    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h3><?php echo isset($_GET['edit']) ? 'Edit' :  'Create New' ?>Create Lvel</h3>
        </div>
        <div class="card-body">
          <form action="" method="a">
            <div class="mb-3">
              <label for="">Service name</label>
              <input value="<?php echo isset($_GET['edit']) ? $rowEdit['level_name'] : '' ?>" type="text" class="form-control" name="level_name" require placeholder="enter level">
            </div>
